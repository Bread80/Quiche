unit CG.LoadStoreMove.Z80.Test;

interface

implementation
uses TestFrameWork,
  Def.IL, Def.QTypes, Def.Consts, Def.Scopes, Def.Variables,
  Lib.Data,
  CodeGen, CG.Data,
  CG.CPUState.Z80, CG.LoadStoreMove.Z80, CG.Load.Z80, CG.Store.Z80,
...
procedure TTestZ80StoreVariable.DoTestStoreVariable(Reg: TCPUReg;
  ...
  VarStorage: TVarStorage; InState, OutCode, OutState: String);
var Param: TILParam;
  V: PVariable;
  Code: String;
  State: String;
