...
//to another.
procedure GenBlockCopy(const ILItem: TILItem);
...
begin
  Assert(False);
(*  ***Check Variable storage/addressing mode for both variables***
  LD HL,<Param1.Variable>
  LD DE,<Dest.Variable>
  LD BC,<GetTypeSize(ILItem.UserType)>
  LDIR
