...
type TQuicheError = (
  ...
  qeCommaOrDotDotExpected,  //For RangeLists - array literals or set literals
  qeCommaExpectedInArray,     //For RangeLists - array literals or set literals
  qeArrayElementTypeMismatch, //Mismatch between types of array elements
...
function ErrOpUsage(ErrClass: TQuicheError;Op: TOperation): TQuicheError;
...
function ErrFuncCall(ErrClass: TQuicheError;Func: TParameteredItem): TQuicheError;
function ErrFuncCallSub(ErrClass: TQuicheError;const Sub: String; Func: TParameteredItem): TQuicheError;
function ErrFuncCallSub2(ErrClass: TQuicheError;const Sub1, Sub2: String;
  Func: TParameteredItem): TQuicheError;
...
function FuncToHelpEx(Func: TParameteredItem): String;
begin
